...
enyo.path.addPaths({layout: "/home/enda/Desktop/bootplate/enyo/../lib/layout/", onyx: "/home/enda/Desktop/bootplate/enyo/../lib/onyx/", onyx: "/home/enda/Desktop/bootplate/enyo/../lib/onyx/source/"});
...
var n = t.tweet;
this.$.tweetDetail.setName(n.from_user_name), this.$.tweetDetail.setText(n.text), enyo.Panels.isScreenNarrow() && this.next();
}
});
...
this.tweets = t.results, this.$.list.setCount(this.tweets.length), this.$.list.refresh();
},
setupItem: function(e, t) {
var n = this.tweets[t.index];
this.$.item.setContent(n.text), this.$.item.addRemoveClass("selected-tweet", e.isSelected(t.index));
},
search: function() {
...
e.response(this, "processResult"), e.go({
